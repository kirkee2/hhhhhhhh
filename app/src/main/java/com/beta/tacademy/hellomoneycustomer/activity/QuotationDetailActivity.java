...
public class QuotationDetailActivity extends CommonBaseActivity {
    public static final int SELECT_QUOTATION_REQUEST_CODE = 0;
    ...
    */
    ...
    protected synchronized void isNetworkSuccess() {
        if (isQuotationDetail && isQuotationFeedback) {
            ...
            quotationDetailRecyclerViewAdapter = new QuotationDetailRecyclerViewAdapter(activity, quotationDetailHeaderObject,quotationDetailObjectArrayList);
